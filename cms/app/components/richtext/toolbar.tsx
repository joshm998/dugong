...
export default function ToolbarPlugin() {
    ...
    return (
        ...
        //     <>
        //       <button
        //         className="toolbar-item block-controls  btn btn-sm"
        //         onClick={() =>
        ...
        //         }}
        //         className={"toolbar-item spaced btn btn-sm " + (isBold ? "btn-active" : "")}
        ...
        //         }}
        //         className={"toolbar-item spaced btn btn-sm " + (isItalic ? "btn-active" : "")}
        ...
        //         }}
        //         className={"toolbar-item spaced btn btn-sm " + (isUnderline ? "btn-active" : "")}
        ...
        //         }}
        //         className={
        //           "toolbar-item spaced btn btn-sm " + (isStrikethrough ? "btn-active" : "")
        //         }
        ...
        //     }}
        //     className="toolbar-item spaced btn btn-sm"
        //     aria-label="Undo"
        //   >
        ...
        //     }}
        //     className="toolbar-item  btn btn-sm"
        //     aria-label="Redo"
        //   >
        ...
        //         <i className="format strikethrough" />
        //       </button>
        <ul className="menu menu-xs gap-1 menu-horizontal bg-base-200 w-full" ref={toolbarRef}>
            <li>
                <button
                    disabled={!canUndo}
                    onClick={() => {
                    ...
                    aria-label="Undo"
                >
                    <span className="text-md p-1"><FaUndo /></span>
                </button>
            </li>
            <li>
                <button
            ...
            <li>
                <button
                    ...
                    aria-label="Format Bold"
                >
                    <span className="text-md p-1"><FaBold /></span>
                </button>
            </li>
            <li>
                <button
                    ...
                    aria-label="Format Italics">
                    <span className="text-md p-1"><FaItalic /></span>
                </button>
            </li>
            <li>
                <button
                    ...
                    aria-label="Format Underline">
                    <span className="text-md p-1"><FaUnderline /></span>
                </button>
            </li>
            <li>
                <button
                    ...
                    aria-label="Format Strikethrough">
                    <span className="text-md p-1"><FaStrikethrough /></span>
                </button>
            </li>
            <li>
                <button
